      ...
      <div class="container">
        <div class="row justify-content-center align-items-center">
          <div class="col-lg-9 text-center mt-5">
            <h1 class="heading" data-aos="fade-up">${detail_board.board_title}</h1>
		...
		<div class="container mt-3">
		  ...
		  <section class="features-1 row ps-4 pe-4 pb-4">
			  <div class="col-10 my-auto">
			  	<input type="hidden" name="board_id" value="${detail_board.board_id}"/> 
				<div class="">
				  <textarea class="form-control" name="content" rows="3" cols="130" placeholder="상대방을 존중하는 댓글을 남겨주세요"></textarea>
				</div>
			  </div>
			...
			<div class="pt-3 ps-4 pe-4" class="sigle-reply">
			  <div class="row my-auto mb-3 ms-2">
 		        <form method="post" class="col-10 form-reply">
				  <input type="hidden" value="${replys.idx}" class="modified-idx" name="reply-idx"/>
			      <p class="row font-weight-bold text-black">${replys.user_id} 님의 댓글</p>
  			      <h6 class="row origin-reply font-weight-bold text-primary heading mb-4" >" ${replys.reply_content} "</h6>
  			      <div class="row modify-div" style="display:none">
				    <textarea class="form-control mb-4" name="modify-content" rows="3" >${replys.reply_content}</textarea>
  			      </div>
   			    </form>
  			    <div class="col-2 mb-3 text-center">
				  <c:if test="${userInfo.id eq replys.user_id}">
	  			  <input type="button" value="수정" class="modify-btn btn-sm btn-primary"/>
	  			  <input type="button" value="삭제" class="delete-btn btn-sm btn-warning"/>
				  </c:if>
